<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl uppercase text-gray-800 dark:text-gray-200 leading-tight mt-1">
                    ...
                    @else
                        <div
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                {!! Str::limit(strip_tags($post->body, '<p>'), 600) !!}
                            </p>
                            <a href="{{ route('posts.show', ['id' => $post->id]) }}"
        ...
        @else
            <div class="text-center mt-16">
                <h1 class="text-red-500 text-2xl">
                    <i class="fa-solid fa-face-sad-tear"></i> Nenhum resultado da pesquisa encontrado!
                </h1>
            </div>
        @endif
